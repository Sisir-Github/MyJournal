...
namespace MyJournal.Services
{
    ...
    public class JournalService
    {
        ...
        // Get all tag names (prebuilt + custom) found in entries
        public async Task<List<string>> GetAllTagNamesAsync()
        {
            var tagStrings = await _context.JournalEntries
                .AsNoTracking()
            ...
            {
                var parts = tagString.Split(',', StringSplitOptions.RemoveEmptyEntries);
